...
<head>
    ...
    <title>Dashboard - CoinMints</title>
...
<body id="page-top">
  ...
  <?php if (isset($_SESSION['success-post'])): ?>
      <script type="text/javascript">
        ...
        <?php
            unset($_SESSION['success-post']);
          ?>
      <?php endif;?>
        <?php if (isset($_SESSION['failed-post'])): ?>
      <script type="text/javascript">
        swal({
        title: "Uploaded Successfully!",
        text: "click the button to exit!",
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-secondary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link active" href="dashboard.html"><i class="fas fa-tachometer-alt"></i><span>Home Feeds</span></a></li>
...
?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="input-group"><span class="input-group-text">What is on Your mind?</span>

                            <input class="form-control" type="text" name="user-post">
                            
                            <button class="btn btn-primary" type="submit" name="submit-post">Post</button>
                        </div>
                    </div>
                </div>
                </form>   
