...
<?php
session_start();
include("php/profile_get_data.php");
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-secondary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item"><a class="nav-link" href="dashboard.html"><i class="fas fa-tachometer-alt"></i><span>Home Feeds</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="profile.html"><i class="fa fa-list-alt"></i><span>WatchList</span></a></li>
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                ...
                                <form class="card-body text-center shadow">
                                     <img src="assets/img/user.png" 
                                            class="rounded mx-auto d-block" id="displaypicture"
                                             onclick="trigger()" 
                                             style="display: block;
                                              width: 100px;
                                               height: 100px;
                                                margin-left: 85px;
                                                 ...
                                                 "
                        value="<?php echo "<img class='img' src='assets/img/".$pic."'" ?>"
                                                 >
                                    
                                            <input type="file" name="profileimage" onchange="display(this)" id="image" style="display: none;" >
                                    ...
                                    <div class="card shadow mb-3">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" >
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3"><label class="form-label" for="username"><strong>Username</strong></label><input class="form-control" type="text" id="username" placeholder="user.name" name="username" value="<?php echo $full_name ?>"></div>
                                                    </div>
                                                    <div class="col">
                                                ...
                                                <div class="mb-3"><button class="btn btn-primary btn-sm" type="submit" name="update-user-info">Save Settings</button></div>
                                            </form>
                                        </div>
                                    </div>
